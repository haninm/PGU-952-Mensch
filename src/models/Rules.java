 ...
 * static final int beadKillEnemyMovePoint = 150;
 * static final int beadGoToGoalMovePoint = 200;
 *
 * static final String[] playerNames = new String[]{"yellow" , "Red" , "Blue" , "Green"};
 */
class Rules {
